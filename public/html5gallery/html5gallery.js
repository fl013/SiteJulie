...
function loadHtml5Gallery(v) {
	...
	jQuery.extend(jQuery.easing, {
		...
		easeInOutExpo: function(b, e, a, c, d) {
			return 0 == e
				...
				: e == d
					? a + c
					: 1 > (e /= d / 2)
						? c / 2 * Math.pow(2, 10 * (e - 1)) + a
						: c / 2 * (-Math.pow(2, -10 * --e) + 2) + a;
		},
		...
		easeInOutCirc: function(b, e, a, c, d) {
			return 1 > (e /= d / 2)
				? -c / 2 * (Math.sqrt(1 - e * e) - 1) + a
				: c / 2 * (Math.sqrt(1 - (e -= 2) * e) + 1) + a;
		},
		...
		easeInOutElastic: function(b, e, a, c, d) {
			...
			f < Math.abs(c) ? ((f = c), (b = h / 4)) : (b = h / (2 * Math.PI) * Math.asin(c / f));
			return 1 > e
				? -0.5 * f * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * d - b) * 2 * Math.PI / h) + a
				: 0.5 * f * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * d - b) * 2 * Math.PI / h) + c + a;
		},
		...
		easeInOutBack: function(b, e, a, c, d, h) {
			void 0 == h && (h = 1.70158);
			return 1 > (e /= d / 2)
				? c / 2 * e * e * (((h *= 1.525) + 1) * e - h) + a
				: c / 2 * ((e -= 2) * e * (((h *= 1.525) + 1) * e + h) + 2) + a;
		},
		...
		easeOutBounce: function(b, e, a, c, d) {
			return (e /= d) < 1 / 2.75
				? c * 7.5625 * e * e + a
				: e < 2 / 2.75
					? c * (7.5625 * (e -= 1.5 / 2.75) * e + 0.75) + a
					: e < 2.5 / 2.75
						? c * (7.5625 * (e -= 2.25 / 2.75) * e + 0.9375) + a
						: c * (7.5625 * (e -= 2.625 / 2.75) * e + 0.984375) + a;
		},
		easeInOutBounce: function(b, e, a, c, d) {
			return e < d / 2
				? 0.5 * jQuery.easing.easeInBounce(b, 2 * e, 0, c, d) + a
				: 0.5 * jQuery.easing.easeOutBounce(b, 2 * e - d, 0, c, d) + 0.5 * c + a;
		}
	});
	var s = jQuery;
		...
		return this.each(function() {
			...
			function b(a) {
				...
				1 <= d.targetTouches.length
					? ((l = d.targetTouches[0].pageX),
						(g = d.targetTouches[0].pageY),
						e.instance && e.preventWebBrowserCallback && (c = e.instance[e.preventWebBrowserCallback](g < j)))
					: h(a);
				c && a.preventDefault();
			}
			function d(a) {
				if (0 < l || 0 < g)
					100 < Math.abs(l - f) &&
						(l > f ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()),
						100 < Math.abs(g - j) &&
							(g > j ? e.swipeBottom && e.swipeBottom.call() : e.swipeTop && e.swipeTop.call());
				h(a);
			}
			function h() {
				g = l = j = f = -1;
		...
		k = (x.drag = {
			...
			setup: function() {
				if (!q.data(this, k.datakey)) {
					var b = q.extend({ related: 0 }, k.defaults);
			...
			teardown: function() {
				q.data(this, k.datakey).related ||
					(q.removeData(this, k.datakey),
			...
			init: function(b) {
				var e = b.data,
					a;
				if (
					!(0 < e.which && b.which != e.which) &&
					!q(b.target).is(e.not) &&
					(!e.handle || q(b.target).closest(e.handle, b.currentTarget).length)
				)
					if (
						((e.propagates = 1),
			...
			interaction: function(b, e) {
				return {
					...
					droppable: [],
					offset: q(b)[e.relative ? 'position' : 'offset']() || { top: 0, left: 0 }
				};
			},
			handler: function(b) {
				var e = b.data;
				switch (b.type) {
					...
					case 'mouseup':
						u.remove(document, 'mousemove mouseup', k.handler),
							e.dragging && (!1 !== e.drop && x.drop && x.drop.handler(b, e), k.hijack(b, 'dragend', e)),
							k.textselect(!0),
							!1 === e.click &&
								e.dragging &&
			...
			delegate: function(b) {
				var e = [],
					a,
					c = q.data(this, 'events') || {};
				q.each(c.live || [], function(c, h) {
					if (0 === h.preType.indexOf('drag') && (a = q(b.target).closest(h.selector, b.currentTarget)[0]))
						u.add(a, h.origType + '.' + k.livekey, h.origHandler, h.data), 0 > q.inArray(a, e) && e.push(a);
				});
				return !e.length
					? !1
					: q(e).on('dragend.' + k.livekey, function() {
						...
						if ((w = a.interactions[g]) && !('dragend' !== e && w.cancelled))
							(r = k.properties(b, a, w)),
								...
								q(d || w[j] || a.droppable).each(function(c, d) {
									r.target = d;
									l = u.handle
										? d ? u.handle.call(d, b, r) : null
										: d ? u.dispatch.call(d, b, r) : null;
									!1 === l
										? ('drag' == j && ((w.cancelled = !0), (a.propagates -= 1)),
											'drop' == e && (w[j][c] = null))
										: 'dropinit' == e && w.droppable.push(k.element(l) || d);
			...
			textselect: function(b) {
				q(document)
					[b ? 'unbind' : 'bind']('selectstart', k.dontstart)
					.attr('unselectable', b ? 'off' : 'on')
					.css('MozUserSelect', b ? '' : 'none');
			},
			dontstart: function() {
				return !1;
			},
	...
	k.callback.prototype = {
		update: function() {
			x.drop &&
				...
				q.each(this.available, function(b) {
					...
					: 'crossfade' == l
						...
						: 'slide' == l
							? ($parent.css({ overflow: 'hidden' }),
								j
									? (a.css({ left: '100%' }),
										a.animate({ left: '0%' }, f, h),
										e.animate({ left: '-100%' }, f, h, function() {
											e.remove();
											d();
										}))
									: (a.css({ left: '-100%' }),
	...
	p.fn.addHTML5VideoControls = function(b, e, a, c, d, h, f, j, l, g, w, r) {
			...
			.css({
				...
				'background-image':
					...
					(l && 'playbutton' in l && 0 < l.playbutton.length
						? l.playbutton
						: b + 'html5boxplayer_playvideo.png') +
					"')",
		...
		m.after(n);
		m.after(J);
		J.css({ display: 'none', position: 'fixed', left: 0, top: 0, bottom: 0, right: 0 });
		n.css({
			display: 'block',
			position: 'absolute',
			width: '100%',
		...
		F.css({
			...
			.hover(
				function() {
					p(this).css({ 'background-position': 'bottom left' });
				},
				function() {
					p(this).css({ 'background-position': 'top left' });
				}
			)
			.on('click', function() {
				m.get(0).play();
		...
		G.css({
			...
			.hover(
				function() {
					p(this).css({ 'background-position': 'bottom right' });
				},
				function() {
					p(this).css({ 'background-position': 'top right' });
				}
			)
			.on('click', function() {
				m.get(0).pause();
		...
		if (
			...
			C.get(0).mozRequestFullScreen ||
			C.get(0).webkitEnterFullScreen ||
			C.get(0).msRequestFullscreen
		) {
			var R = function(a) {
				f
					? a
						? (m.get(0).setAttribute('controls', 'controls'),
							j && m.get(0).setAttribute('controlsList', 'nodownload'))
						: m.get(0).removeAttribute('controls')
					: a
						? (p(document).on('mousemove', P),
							n.css({ 'z-index': 2147483647, position: 'fixed' }),
							J.css({ 'z-index': 2147483647, display: 'block' }),
							t.css({ 'z-index': 2147483647 }))
						: (p(document).off('mousemove', P),
							n.css({ 'z-index': '', position: 'absolute' }),
							J.css({ 'z-index': '', display: 'none' }),
							t.css({ 'z-index': '' }));
			};
			...
			f ||
				p('head').append(
					"<style type='text/css'>video" + a + '::-webkit-media-controls { display:none !important; }</style>'
				);
			p('.html5boxFullscreen', n)
				.css({
					display: 'block',
					position: 'relative',
					float: 'right',
				...
				.hover(
					function() {
						var a = p(this).css('background-position')
							? p(this).css('background-position').split(' ')[0]
							: p(this).css('background-position-x');
						p(this).css({ 'background-position': a + ' bottom' });
					},
					function() {
						var a = p(this).css('background-position')
							? p(this).css('background-position').split(' ')[0]
						...
						? (f &&
							...
							C.get(0).requestFullscreen
								...
								: C.get(0).webkitRequestFullScreen
									...
									: C.get(0).mozRequestFullScreen
										? C.get(0).mozRequestFullScreen()
										: C.get(0).webkitEnterFullScreen && C.get(0).webkitEnterFullScreen(),
							C.get(0).msRequestFullscreen && C.get(0).msRequestFullscreen())
		...
		if (E)
			p('.html5boxHD', n)
				...
				.on('click', function() {
					I = !I;
					p(this).css({ 'background-position': (I ? 'right' : 'left') + ' center' });
					e.isHd = I;
		...
		if (g) {
			...
			Z.css({
				...
				.on('click', function() {
					...
					Z.data('showcaption', a).css({ 'background-position': (a ? 'right' : 'left') + ' center' });
		...
		if (m.get(0).volume === a / 2 + 0.1) {
				...
				.hover(
					...
					function() {
						var a = p(this).css('background-position')
							? p(this).css('background-position').split(' ')[0]
							: p(this).css('background-position-x');
						p(this).css({ 'background-position': a + ' top' });
					}
				)
				.on('click', function() {
					var a = m.get(0).volume;
					0 < a ? ((da = a), (a = 0)) : (a = da);
					var b = p(this).css('background-position')
						? p(this).css('background-position').split(' ')[1]
						: p(this).css('background-position-y');
					X.css({ 'background-position': (0 < a ? 'left' : 'right') + ' ' + b });
					0 < a && (m.get(0).muted = !1);
					m.get(0).volume = a;
					U.css({ height: Math.round(100 * a) + '%' });
				});
			...
			M.on(q, function(a) {
				...
				a = 1 < a ? 1 : 0 > a ? 0 : a;
				U.css({ height: Math.round(100 * a) + '%' });
				X.css({ 'background-position': 'left ' + (0 < a ? 'top' : 'bottom') });
				0 < a && (m.get(0).muted = !1);
				m.get(0).volume = a;
				M.on(u, function(a) {
					a = 1 - ((k ? a.originalEvent.touches[0] : a).pageY - M.offset().top) / M.height();
		...
		a = function() {
			if (
				m.get(0).buffered &&
				0 < m.get(0).buffered.length &&
				!isNaN(m.get(0).buffered.end(0)) &&
				!isNaN(m.get(0).duration)
			) {
				var a = D.width();
				T.css({ width: Math.round(a * m.get(0).buffered.end(0) / m.get(0).duration) });
			}
		};
		try {
	...
	b.fn.html5gallery = function(k) {
		var e = function(a, c, d) {
			...
			this.options.isOpera =
				null != navigator.userAgent.match(/Opera/i) || null != navigator.userAgent.match(/OPR\//i);
			this.options.isSafari = null != navigator.userAgent.match(/Safari/i);
			this.options.isIE11 =
				null != navigator.userAgent.match(/Trident\/7/) && null != navigator.userAgent.match(/rv:11/);
			...
			this.options.isIOSLess5 =
				this.options.isIPad &&
				this.options.isIPhone &&
				(null != navigator.userAgent.match(/OS 4/i) || null != navigator.userAgent.match(/OS 3/i));
			this.options.supportCSSPositionFixed = !this.options.isIE6 && !this.options.isIOSLess5;
			this.eStart = (this.isTouch = 'ontouchstart' in window || this.options.forcetouch)
				? 'touchstart'
				: 'mousedown';
			...
			this.options.googlefonts &&
				0 < this.options.googlefonts.length &&
				((a = 'https://fonts.googleapis.com/css?family=' + this.options.googlefonts),
		...
		e.prototype = {
			...
			init: function(a) {
				...
				a.options.showcarousel =
					(1 < a.elemArray.length || a.options.showcarouselforsingle) && a.options.showcarousel;
				// a.options.watermarkcode = '';
				// a.options.frve
				// 	? (a.options.watermarkcode =
				// 			"<a style='text-decoration:none;' target='_blank' href='" + a.options.freelink + "' >")
				// 	: 0 < a.options.watermarklink.length &&
				// 		(a.options.watermarkcode =
				// 			"<a style='text-decoration:none;' target='_blank' href='" + a.options.watermarklink + "' >");
				// a.options.watermarkcode +=
				// 	'<div ' +
				// 	(a.options.frve ? '' : "class='html5gallery-watermark-" + a.id + "' ") +
				// 	"style='" +
				// 	(a.options.frve
				...
				// 		: 0 < a.options.watermark.length
				// 			? 'display:block;position:absolute;top:0px;left:0px;'
				// 			: 'display:none;') +
				// 	"' >";
				a.options.frve
					? (a.options.watermarkcode += a.options.frvem)
					: 0 < a.options.watermark.length &&
						(a.options.watermarkcode += "<img src='" + a.options.watermark + "' alt='' />");
			...
			createSocial: function(a) {
				...
				if (this.options.showsocial) {
					var c = this;
					b('head').append(
						"<style type='text/css' data-creator='html5gallery'>.html5gallery-rotate { border-radius:50%; -webkit-transition:-webkit-transform .4s ease-in; transition: transform .4s ease-in; } .html5gallery-rotate:hover { -webkit-transform: rotate(360deg); transform: rotate(360deg); }</style>"
					);
					var d = '<div',
						d = a
							? d +
								(' class="html5gallery-fullscreen-social-' +
									this.id +
									'" style="display:none;' +
									this.options.socialpositionlightbox +
									'"')
							: d +
								(' class="html5gallery-social-' +
									this.id +
									'" style="display:' +
									('mouseover' == this.options.socialmode ? 'none' : 'block') +
									';' +
									this.options.socialposition +
									'"'),
						d = d + '>',
						h =
							('horizontal' == this.options.socialdirection
					...
					a
						? b('.html5gallery-fullscreen-box-' + this.id, this.$fullscreen).append(d)
						: (b('.html5gallery-box-' + this.id, this.$gallery).append(d),
							'mouseover' == this.options.socialmode &&
								b('.html5gallery-box-' + this.id).hover(
									function() {
					...
					b('.html5gallery-social-btn-' + this.id).click(function() {
						...
						var e =
								5 == c.elemArray[c.curElem][9] ||
								6 == c.elemArray[c.curElem][9] ||
								7 == c.elemArray[c.curElem][9] ||
								8 == c.elemArray[c.curElem][9] ||
								9 == c.elemArray[c.curElem][9] ||
								10 == c.elemArray[c.curElem][9] ||
								11 == c.elemArray[c.curElem][9],
							d = d ? c.html2Text(d) : '';
						e && c.elemArray[c.curElem][12] && (h = c.absoluteUrl(c.elemArray[c.curElem][12]));
						b(this).hasClass('html5gallery-social-facebook')
							? window.open(
							...
							: b(this).hasClass('html5gallery-social-twitter')
								? window.open(
								...
								: b(this).hasClass('html5gallery-social-pinterest')
									? window.open(
									...
									: b(this).hasClass('html5gallery-social-linkedin')
										? window.open(
										...
										: b(this).hasClass('html5gallery-social-gplus')
											? window.open(
													'https://plus.google.com/share?url=' + encodeURIComponent(a),
													'_blank'
												)
											: b(this).hasClass('html5gallery-social-email') &&
												window.open(
													'mailto:?subject=' +
														encodeURIComponent(d) +
														'&body=Check out this: ' +
				...
				if (this.options.frve) {
					...
					if (0 > a.text().indexOf(this.options.frvem) || 0 > c.length)
						...
						'none' == c.css('display') ||
							...
							8 > parseInt(c.css('font-size')) ||
							'none' == a.css('display') ||
							'hidden' == a.css('visibility') ||
							8 > parseInt(a.css('font-size')))
					)
						c.attr({
							style:
								(c.attr('style') || '') +
			...
			initData: function(a) {
				...
				if (this.options.src && 0 < this.options.src.length) {
					...
					this.options.xmlnocache &&
						((this.options.xml += 0 > this.options.xml.indexOf('?') ? '?' : '&'),
						...
						success: function(c) {
							b(c).find('slide').each(function(a) {
								var c = b(this).find('title').text(),
									h = b(this).find('description').text()
										? b(this).find('description').text()
										: b(this).find('information').text();
								c || (c = '');
								h || (h = '');
								var e = b(this).find('mediatype').text()
									? b(this).find('mediatype').text()
									: d.checkType(b(this).find('file').text());
								d.elemArray.push([
									b(this).find('id').length ? b(this).find('id').text() : a,
									b(this).find('thumbnail').text(),
									b(this).find('file').text(),
									b(this).find('file-ogg').text(),
									b(this).find('file-webm').text(),
									b(this).find('link').text(),
									b(this).find('linktarget').text(),
									c,
									h,
									e,
									b(this).find('width').length && !isNaN(parseInt(b(this).find('width').text()))
										? parseInt(b(this).find('width').text())
										: d.options.width,
									b(this).find('height').length && !isNaN(parseInt(b(this).find('height').text()))
										? parseInt(b(this).find('height').text())
										: d.options.height,
									b(this).find('poster').text(),
									b(this).find('hd').text(),
									b(this).find('hdogg').text(),
									b(this).find('hdwebm').text(),
									b(this).find('duration').text(),
									b(this).find('lightboxwidth').text(),
									b(this).find('lightboxheight').text(),
									b(this).find('youtubeapikey').text(),
									b(this).find('youtubeplaylistid').text(),
									b(this).find('youtubeplaylistmaxresults').text(),
									'true' == b(this).find('lightbox').text().toLowerCase()
								]);
							});
							d.readTags();
							a(d);
					...
					this.options.remote && 0 < this.options.remote.length
						? ((d = this),
							b.getJSON(this.options.remote, function(b) {
								for (var c = 0; c < b.length; c++) {
									...
									d.elemArray.push([
										...
										b[c].description,
										e,
										b[c].width && !isNaN(parseInt(b[c].width))
											? parseInt(b[c].width)
											: d.options.width,
										b[c].height && !isNaN(parseInt(b[c].height))
											? parseInt(b[c].height)
											: d.options.height,
										b[c].poster,
										b[c].hd,
						...
						: this.options.youtubechannel
							? ((c = {
									alt: 'json',
									v: 2,
									orderby: this.options.youtubechannel.orderby
										? this.options.youtubechannel.orderby
										: 'published',
									'start-index': this.options.youtubechannel['start-index']
										? this.options.youtubechannel['start-index']
										: 1,
									'max-results': this.options.youtubechannel['max-results']
										? this.options.youtubechannel['max-results']
										: 10
								}),
								this.options.youtubechannel.author
									? (c.author = this.options.youtubechannel.author)
									: this.options.youtubechannel.q && (c.q = this.options.youtubechannel.q),
										...
										for (var c = 1; c < b.feed.entry.length; c++)
											d.elemArray.push([
												...
												'https://img.youtube.com/vi/' +
													b.feed.entry[c].media$group.yt$videoid.$t +
													'/' +
													d.options.youtubethumb,
												b.feed.entry[c].media$group.media$player.url,
												null,
												null,
												null,
												null,
												b.feed.entry[c].media$group.media$title.$t,
												b.feed.entry[c].media$group.media$description.$t,
												9,
												640,
												480,
												'https://img.youtube.com/vi/' +
							...
							: this.options.youtubeapikey && this.options.youtubeplaylistid
								? ((d = this),
			...
			readTags: function() {
				...
				(b('img.html5galleryimg', this.container).length
					? b('img.html5galleryimg', this.container)
			...
			getYouTubePlaylist: function(a, c, d, e, f, j, l) {
				...
				var g =
					'https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=' + c + '&key=' + a;
				...
				b
					.getJSON(g, function(b) {
						if (b && b.items)
							for (var g = 0; g < b.items.length; g++) {
								...
								j.options.youtubeplaylistusemaxres &&
									(b.items[g].snippet.thumbnails && b.items[g].snippet.thumbnails.maxres) &&
									(k = b.items[g].snippet.thumbnails.maxres.url);
								l = [
									g,
									'https://img.youtube.com/vi/' + l + '/' + j.options.youtubethumb,
									'https://www.youtube.com/embed/' + l,
									null,
									null,
									null,
									null,
									b.items[g].snippet.title,
									b.items[g].snippet.description,
									9,
									640,
									480,
									k,
						...
						b &&
							(b.nextPageToken && d && 50 < d) &&
							((w = !1), j.getYouTubePlaylist(a, c, d - 50, e, f, j, b.nextPageToken));
					})
					.always(function() {
						w && f(j);
					});
			...
			createMarkup: function() {
				this.$gallery = jQuery(
					"<div class='html5gallery-container-" +
						...
						this.id +
						"'></div><div class='html5gallery-title-" +
						this.id +
						"'></div><div class='html5gallery-timer-" +
						this.id +
						"'></div><div class='html5gallery-viral-" +
						this.id +
						"'></div><div class='html5gallery-toolbox-" +
						this.id +
						"'><div class='html5gallery-toolbox-bg-" +
						this.id +
						"'></div><div class='html5gallery-toolbox-buttons-" +
						this.id +
						"'><div class='html5gallery-play-" +
						this.id +
						"'></div><div class='html5gallery-pause-" +
						this.id +
						"'></div><div class='html5gallery-left-" +
						this.id +
						"'></div><div class='html5gallery-right-" +
						this.id +
						"'></div><div class='html5gallery-lightbox-" +
						this.id +
						"'></div></div></div></div><div class='html5gallery-car-" +
						this.id +
						...
						this.id +
						"'></div></div><div class='html5gallery-car-slider-bar-" +
						this.id +
						"'><div class='html5gallery-car-slider-bar-top-" +
						this.id +
						"'></div><div class='html5gallery-car-slider-bar-middle-" +
						this.id +
						"'></div><div class='html5gallery-car-slider-bar-bottom-" +
						this.id +
						"'></div></div><div class='html5gallery-car-left-" +
						this.id +
						"'></div><div class='html5gallery-car-right-" +
						this.id +
						"'></div><div class='html5gallery-car-slider-" +
						this.id +
						"'></div></div></div></div>"
				);
			...
			createSocialMedia: function() {
				...
				if (this.options.showsocialmedia && this.options.showfacebooklike) {
					var c =
						...
						c =
							this.options.facebooklikeurl && 0 < this.options.facebooklikeurl.length
								? c + encodeURIComponent(this.options.facebooklikeurl)
								: c + a;
					b('.html5gallery-viral-' + this.id, this.$gallery).append(
						c +
				...
				this.options.showsocialmedia &&
					...
					(c =
						this.options.twitterurl && 0 < this.options.twitterurl.length
							? c + (" data-url='" + this.options.twitterurl + "'")
							: c + (" data-url='" + a + "'")),
					this.options.twitterusername &&
						0 < this.options.twitterusername.length &&
						(c +=
							" data-via='" +
				...
				this.options.showsocialmedia &&
					...
					((c =
						"<div style='display:block; float:left; width:100px; height:21px;'><div class='g-plusone' data-size='medium'"),
					(c =
						this.options.googleplusurl && 0 < this.options.googleplusurl.length
							? c + (" data-href='" + this.options.googleplusurl + "'")
							: c + (" data-href='" + a + "'")),
			...
			createSliderTimeout: function() {
				var a = this;
				a.slideshowTimeout = new HTML5GalleryTimer(
				...
				a.options.pauseonmouseover &&
					b('.html5gallery-elem-' + this.id, this.$gallery).hover(
						function() {
			...
			updateTimer: function(a) {
				this.isFullscreen
					? ((a = Math.max(
							0,
							Math.floor(
								b('.html5gallery-fullscreen-elem-wrapper-' + this.id, this.$fullscreen).width() * a
							)
						)),
						b('.html5gallery-fullscreen-timer-' + this.id, this.$fullscreen).css({ width: a + 'px' }))
					: ((a = Math.max(0, Math.floor(b('.html5gallery-elem-' + this.id, this.$gallery).width() * a))),
						b('.html5gallery-timer-' + this.id, this.$gallery).css({ width: a + 'px' }));
			},
			createEvents: function() {
				...
				if (!('ontouchstart' in window) || !a.options.disablehovereventontouch)
					b('.html5gallery-box-' + this.id, this.$gallery).mousemove(function() {
						if ('mouseover' == a.options.imagetoolboxmode) {
							...
							('always' == a.options.showimagetoolbox ||
								('image' == a.options.showimagetoolbox && 1 == c)) &&
								a.showimagetoolbox(c, !0);
						}
						if (
							a.options.titleoverlay &&
							a.options.titleautohide &&
							(!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying)
						)
						...
						b('.html5gallery-box-' + this.id, this.$gallery).hover(
							function() {
								a.onSlideshowOver();
								if ('mouseover' == a.options.imagetoolboxmode) {
									var c = a.elemArray[a.curElem][9];
				...
				if (
					'vertical' == this.options.skin ||
					'verticallight' == this.options.skin ||
					'showcase' == this.options.skin ||
					'verticalwithleft' == this.options.skin ||
					'verticallightwithleft' == this.options.skin
				)
					b(
						'.html5gallery-car-list-' + this.id,
						this.$gallery
					).on('DOMMouseScroll mousewheel wheel', function(c) {
						c.preventDefault();
						...
						if (!(e < a.options.thumbMaskHeight)) {
							var e = -1 * (e - a.options.thumbMaskHeight),
								f = 0;
							c.originalEvent &&
								(c.originalEvent.wheelDeltaY
									? (f = c.originalEvent.wheelDeltaY)
									: c.originalEvent.detail
										? (f = -20 * c.originalEvent.detail)
										: c.originalEvent.wheelDelta
											? (f = c.originalEvent.wheelDelta)
											: c.originalEvent.deltaY &&
												(f = a.options.isFirefox
													? -10 * c.originalEvent.deltaY
													: -1 * c.originalEvent.deltaY));
				...
				'ontouchstart' in window ||
					(b('.html5gallery-car-left-' + this.id, this.$gallery).hover(
						function() {
							b(this).data('disabled') ||
					...
					b('.html5gallery-car-right-' + this.id, this.$gallery).hover(
						function() {
							b(this).data('disabled') ||
								b(this).css({ 'background-position': '-' + a.options.carouselarrowwidth + 'px 0px' });
						},
			...
			resizeStyleVertical: function() {
				if (this.container.parent() && this.container.parent().width()) {
					...
					if (this.options.carouselposresponsive) {
						...
						a < this.options.carouselposresponsiveonscreenwidth
							? (this.options.carouselposition = 'bottom')
					...
					this.options.showcarousel &&
						(this.options.carouselWidth =
							'bottom' == this.options.carouselposition ? this.options.width : this.options.thumbwidth);
					'bottom' == this.options.carouselposition
						? (this.options.width = this.options.totalWidth - 2 * this.options.padding)
						: ((this.options.width = this.options.totalWidth - 2 * this.options.padding),
							0 < this.options.carouselWidth + this.options.carouselmargin &&
					...
					this.options.responsivefullscreen && 0 < this.container.parent().height()
						...
						: ((this.options.height = Math.round(
								this.options.width * this.options.originalHeight / this.options.originalWidth
							)),
							(this.options.totalHeight =
								'bottom' == this.options.carouselposition
									? this.options.height +
					...
					this.options.showcarousel &&
						('bottom' == this.options.carouselposition
							? ((this.options.carouselWidth = this.options.width),
								...
								(this.options.carouselSlider =
									Math.floor(
										this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)
							...
							: ((this.options.carouselWidth = this.options.thumbwidth),
								...
								'left' == this.options.carouselposition
						...
						this.options.isMobile || (this.isTouch && this.options.splitvsliderontouch)
						...
						this.options.thumbshowtitle &&
							b('head').append(
								"<style type='text/css' data-creator='html5gallery'>.html5gallery-tn-title-" +
									this.id +
									' {width: ' +
									a +
									'px;}</style>'
					...
					if (1 == a || this.showingPoster) {
						var c = this.showingPoster
								? this.elemArray[this.curElem][23]
								: this.elemArray[this.curElem][10],
							d = this.showingPoster
								? this.elemArray[this.curElem][24]
								: this.elemArray[this.curElem][11],
							e;
						this.isFullscreen
							? ((a = this.elemArray[this.curElem][17]
									? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth)
									: this.fullscreenWidth),
								(e = this.elemArray[this.curElem][18]
									? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight)
									: this.fullscreenHeight),
								(e = Math.min(a / c, e / d)),
								(e = 1 < e ? 1 : e))
							: (e =
									'fill' == this.options.resizemode
										? Math.max(this.options.width / c, this.options.height / d)
										: Math.min(this.options.width / c, this.options.height / d));
						a = Math.round(e * c);
						e = Math.round(e * d);
						...
						(d = this.elemArray[this.curElem][10]),
							...
							this.isFullscreen
								? ((a = this.elemArray[this.curElem][17]
									...
									(d = Math.round(e * d)),
									(c = Math.round(e * c)),
									this.adjustFullscreen(d, c, !0))
								: ((d = this.options.width), (c = this.options.height)),
							b('.html5gallery-elem-' + this.id).css({ width: d + 'px', height: c + 'px' }),
							b('.html5gallery-elem-video-' + this.id).css({ width: d + 'px', height: c + 'px' }),
							b('.html5gallery-elem-video-container-' + this.id).css({ width: '100%', height: '100%' }),
							b('.html5gallery-elem-video-container-' + this.id)
								.find('video')
					...
					this.options.showcarousel &&
						...
						this.options.carouselSlider &&
							...
							b('.html5gallery-car-slider-bar-' + this.id).css({ display: 'block' }),
							b('.html5gallery-car-left-' + this.id).css({ display: 'block' }),
							b('.html5gallery-car-right-' + this.id).css({ display: 'block' }),
							b('.html5gallery-car-slider-' + this.id).css({ display: 'block' })),
						(a = 0),
						this.options.carouselNavButton &&
							(a = Math.round(this.options.carAreaLength / 2 - this.options.thumbMaskHeight / 2)),
						b('.html5gallery-car-mask-' + this.id).css({
							top: a + 'px',
							height: this.options.thumbMaskHeight + 'px'
						}),
			...
			createStyleVertical: function() {
				...
				this.options.thumbimagewidth = this.options.thumbshowtitle
					? this.options.thumbheight - 2 * this.options.thumbimageborder - 4
				...
				'top' == this.options.headerpos
					? ((c = 0), (a = this.options.socialheight), (this.options.elemTop = this.options.headerHeight))
					: 'bottom' == this.options.headerpos
						? ((this.options.elemTop = 0),
							(a = this.options.titleoverlay
								? this.options.height - this.options.titleheight
								: this.options.height),
							(c = this.options.titleoverlay
								? this.options.height
								: this.options.height + this.options.titleheight))
						: 'bottomoutside' == this.options.headerpos &&
							(a = this.options.showcarousel
								? this.options.height + this.options.carouselHeight
								: this.options.height);
				var d =
					' .html5gallery-container-' +
					this.id +
					' { display:block; position:absolute; left:0px; top:0px; width:' +
					this.options.totalWidth +
					'px; height:' +
					this.options.totalHeight +
					'px; ' +
					(!this.options.bgimage ? '' : "background:url('" + this.options.bgimage + "') center top;") +
					' background-color:' +
				...
				var d =
						...
						(' .html5gallery-box-' +
							this.id +
							' {display:block; position:absolute; text-align:center; left:' +
							this.options.boxLeft +
							'px; top:' +
							this.options.boxTop +
							'px; width:' +
					...
					d =
						...
						(' .html5gallery-fullscreen-title-' +
							this.id +
							'' +
							this.options.lightboxtitlecss +
							' .html5gallery-fullscreen-title-' +
							this.id +
							'' +
							this.options.lightboxtitlelinkcss),
					d =
						d +
						(' .html5gallery-fullscreen-description-' +
							this.id +
							'' +
							this.options.lightboxdescriptioncss +
							' .html5gallery-fullscreen-description-' +
							this.id +
							'' +
							this.options.lightboxdescriptionlinkcss),
					d =
						d +
						(' .html5gallery-viral-' +
							this.id +
					...
					d =
						...
						(' .html5gallery-title-' +
							this.id +
							' {display:' +
							(this.options.titleoverlay && this.options.titleautohide ? 'none' : 'block') +
							'; position:absolute; left:0px; width:' +
							c +
							'px; '),
					d = this.options.titleoverlay
						? 'top' == this.options.headerpos
							? d + 'top:0px; height:auto; }'
							: d + 'bottom:0px; height:auto; }'
					...
					d =
						...
						(' .html5gallery-elem-' +
							this.id +
							' {display:block; overflow:hidden; position:absolute; top:' +
							...
							this.options.height +
							'px;}');
				this.options.isIE7 || this.options.isIE6
					? ((d += ' .html5gallery-loading-' + this.id + ' {display:none; }'),
						(d += ' .html5gallery-loading-center-' + this.id + ' {display:none; }'))
					: ((d +=
							' .html5gallery-loading-' +
							this.id +
							" {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" +
							this.options.skinfolder +
							"loading.gif') no-repeat top right;}"),
						(d +=
				...
				this.options.slideshadow &&
					((d += ' .html5gallery-title-' + this.id + ' { padding:4px;}'),
				...
				this.options.showcarousel
					? ((d +=
							' .html5gallery-car-' +
							this.id +
							' { position:absolute; display:block; overflow:hidden; width:' +
							this.options.carouselWidth +
							'px; height:' +
							this.options.carouselHeight +
							'px; left:' +
						...
						(d +=
							...
							String(this.elemArray.length * (this.options.thumbheight + this.options.thumbgap)) +
							'px;}'),
						(this.options.thumbShowNum = Math.floor(
							this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)
						)),
						...
						(d +=
							...
							'px; width:14px;}'),
						(d +=
							' .html5gallery-car-slider-bar-top-' +
							this.id +
							" { position:absolute; display:block; top:0px; left:0px; width:14px; height:16px; background:url('" +
							this.options.skinfolder +
							"bartop.png')}"),
						(d +=
							...
							"bar.png')}"),
						(d +=
							' .html5gallery-car-slider-bar-bottom-' +
							this.id +
							" { position:absolute; display:block; bottom:0px; left:0px; width:14px; height:16px; background:url('" +
							this.options.skinfolder +
							"barbottom.png')}"),
						(d =
							this.options.isMobile || (this.isTouch && this.options.splitvsliderontouch)
								? d +
									(' .html5gallery-car-left-' +
										...
										this.options.skinfolder +
										"slidertop.png')}  .html5gallery-car-right-" +
										this.id +
										' { position:absolute; display:' +
										(this.options.carouselSlider ? 'block' : 'none') +
										'; cursor:pointer; overflow:hidden; width:16px; height:35px; left:' +
						...
						this.options.carouselbgtransparent
							...
							: (this.options.isIE ||
								...
								(d +=
									...
									', ' +
									this.options.carouselbgcolorend +
									') no-repeat; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=' +
									this.options.carouselbgcolorstart +
									', endColorstr=' +
									this.options.carouselbgcolorend +
									") no-repeat; -ms-filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr=" +
									this.options.carouselbgcolorstart +
									', endColorstr=' +
									this.options.carouselbgcolorend +
									")' no-repeat;")),
						this.options.carouselbgimage &&
							(d +=
								"background:url('" +
								this.options.skinfolder +
								this.options.carouselbgimage +
						...
						this.options.carouselbgtransparent
							...
							: (this.options.isIE ||
									(d +=
										'border-top:1px solid ' +
										this.options.carouselhighlighttopborder +
										'; border-bottom:1px solid ' +
						...
						(d +=
							...
							Math.round(100 * this.options.thumbopacity) +
							'); opacity:' +
						...
						this.options.thumbshowimage
							? ((c -= this.options.thumbimagewidth + 2 * this.options.thumbimageborder),
								(a = this.options.thumbshowtitle
									? this.options.thumbmargin
									: this.options.thumbwidth / 2 -
										(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) / 2),
								(e = Math.round(
									(this.options.thumbheight - 2) / 2 -
										(this.options.thumbimageheight + 2 * this.options.thumbimageborder) / 2
								)),
								(d +=
									' .html5gallery-tn-img-' +
									this.id +
									...
									'px;}'))
							: (d += ' .html5gallery-tn-img-' + this.id + ' {display:none;}'),
						this.options.thumbshowtitle
							? ((d +=
									...
									'px;' +
									(this.options.thumbshowdescription
										? ''
										: 'line-height:' + String(this.options.thumbheight - 2) + 'px;') +
									'}'),
								(d += ' .html5gallery-tn-title-' + this.id + this.options.thumbtitlecss),
								(d += ' .html5gallery-tn-description-' + this.id + this.options.thumbdescriptioncss))
							: ((d += ' .html5gallery-tn-title-' + this.id + ' {display:none;}'),
								(d += ' .html5gallery-tn-description-' + this.id + ' {display:none;}')),
						(this.carouselHighlight = function(a) {
							b('#html5gallery-tn-' + this.id + '-' + a, this.$gallery)
								.removeClass('html5gallery-tn-' + this.id)
								.addClass('html5gallery-tn-selected-' + this.id);
							if (!(this.options.thumbShowNum >= this.elemArray.length)) {
								a =
									Math.floor(a / this.options.thumbShowNum) *
								...
								var c =
										a /
										(this.elemArray.length * (this.options.thumbheight + this.options.thumbgap) -
											this.options.thumbMaskHeight),
								...
								b('.html5gallery-thumbs-' + this.id, this.$gallery)
									.stop(!0)
									.animate({ marginTop: -1 * a }, 300);
								this.updateCarouseButtons(-a);
							}
						}),
						(this.carouselBarClicked = function(a) {
							var c = b('.html5gallery-thumbs-' + this.id, this.$gallery);
							a.pageY > b('.html5gallery-car-slider-' + this.id, this.$gallery).offset().top
								? ((a =
										-1 * parseInt(c.css('margin-top')) +
						...
						(this.carouselNext = function() {
							...
							if (
								...
								var c =
									-1 * parseInt(a.css('margin-top')) +
									this.options.thumbShowNum * (this.options.thumbheight + this.options.thumbgap);
								c >= this.options.thumbTotalHeight - this.options.thumbMaskHeight &&
									(c = this.options.thumbTotalHeight - this.options.thumbMaskHeight);
								a.animate({ marginTop: -c }, 500, this.options.carouseleasing);
								this.updateCarouseButtons(-c);
							}
						...
						(this.updateCarouseButtons = function(a) {
							...
							0 == a
								? (c.css({
									...
									c.data('disabled', !0))
								: c.data('disabled') &&
									(c.css({ 'background-position': '0px 0px', cursor: 'pointer' }),
									c.data('disabled', !1));
							a == e
								? (d.css({
										'background-position': '-' + String(2 * this.options.carouselarrowwidth) + 'px 0px',
									...
									d.data('disabled', !0))
								: d.data('disabled') &&
									(d.css({ 'background-position': '0px 0px', cursor: 'pointer' }),
									d.data('disabled', !1));
						}))
			...
			resizeImageToolbox: function() {
				if ('center' != this.options.imagetoolboxstyle) {
					var a = Math.round(
							('bottom' == this.options.headerpos || 'bottomoutside' == this.options.headerpos
								? 0
								: this.options.headerHeight) +
				...
				if ('never' != this.options.showimagetoolbox) {
					...
					if ('center' == this.options.imagetoolboxstyle)
						(a =
							...
							this.id +
							' {display:' +
							('show' == this.options.imagetoolboxmode ? 'block' : 'none') +
							'; overflow:hidden; position:relative; margin:0px auto; text-align:center; height:40px;}'),
							(a +=
								' .html5gallery-toolbox-bg-' +
								this.id +
								' {display:block; left:0px; top:0px; width:100%; height:100%; position:absolute; filter:alpha(opacity=60); opacity:0.6; background-color:#222222; }'),
							(a +=
								' .html5gallery-toolbox-buttons-' +
								this.id +
								' {display:block; margin:0px auto; height:100%;}'),
							(a +=
								' .html5gallery-play-' +
								this.id +
						...
						var c = Math.round(
								('bottom' == this.options.headerpos ? 0 : this.options.headerHeight) +
									this.options.height / 2 -
									24
							),
					...
					b('.html5gallery-play-' + this.id, this.$gallery).hover(
						function() {
					...
					b('.html5gallery-pause-' + this.id, this.$gallery).hover(
						function() {
							b(this).css({ 'background-position': 'right top' });
						},
						function() {
					...
					b('.html5gallery-left-' + this.id, this.$gallery).hover(
						function() {
							b(this).css({ 'background-position': 'right top' });
						},
						function() {
					...
					b('.html5gallery-right-' + this.id, this.$gallery).hover(
						function() {
							b(this).css({ 'background-position': 'right top' });
						},
						function() {
					...
					b('.html5gallery-lightbox-' + this.id, this.$gallery).hover(
						function() {
							b(this).css({ 'background-position': 'right top' });
						},
						function() {
				...
				this.showimagetoolbox = function(a, c) {
					if (
						...
						if ('center' == this.options.imagetoolboxstyle) {
							...
							this.options.showplaybutton &&
							(1 == a ||
								(this.options.showplaypausefullscreenforall &&
									(!this.options.hideplaypausefullscreenwhenvideoisplaying || !this.isVideoPlaying)))
								? ((e += 36),
									this.isPaused
										? (b('.html5gallery-play-' + this.id, this.$gallery).show(),
											b('.html5gallery-pause-' + this.id, this.$gallery).hide())
								...
								: (b('.html5gallery-play-' + this.id, this.$gallery).hide(),
									b('.html5gallery-pause-' + this.id, this.$gallery).hide());
							this.options.showprevbutton
								? ((e += 36), b('.html5gallery-left-' + this.id, this.$gallery).show())
								: b('.html5gallery-left-' + this.id, this.$gallery).hide();
							this.options.shownextbutton
								? ((e += 36), b('.html5gallery-right-' + this.id, this.$gallery).show())
								: b('.html5gallery-right-' + this.id, this.$gallery).hide();
							this.options.showfullscreenbutton &&
							(1 == a ||
								(this.options.showplaypausefullscreenforall &&
									(!this.options.hideplaypausefullscreenwhenvideoisplaying || !this.isVideoPlaying)))
								? ((e += 36), b('.html5gallery-lightbox-' + this.id, this.$gallery).show())
							...
							(1 == a ||
								...
								: (b('.html5gallery-play-' + this.id, this.$gallery).hide(),
									b('.html5gallery-pause-' + this.id, this.$gallery).hide()),
								this.options.showprevbutton
									? b('.html5gallery-left-' + this.id, this.$gallery).show()
									: b('.html5gallery-left-' + this.id, this.$gallery).hide(),
								this.options.shownextbutton
									? b('.html5gallery-right-' + this.id, this.$gallery).show()
									: b('.html5gallery-right-' + this.id, this.$gallery).hide(),
								this.options.showfullscreenbutton &&
								(1 == a ||
									(this.options.showplaypausefullscreenforall &&
										(!this.options.hideplaypausefullscreenwhenvideoisplaying ||
											!this.isVideoPlaying)))
									? b('.html5gallery-lightbox-' + this.id, this.$gallery).show()
									: b('.html5gallery-lightbox-' + this.id, this.$gallery).hide();
						this.options.isIE678 || c
							? b('.html5gallery-toolbox-' + this.id, this.$gallery).show()
							: b('.html5gallery-toolbox-' + this.id, this.$gallery).fadeIn();
					}
				};
				this.hideimagetoolbox = function() {
					'show' != this.options.imagetoolboxmode &&
						...
						this.options.isIE678
							? b('.html5gallery-toolbox-' + this.id, this.$gallery).hide()
							: b('.html5gallery-toolbox-' + this.id, this.$gallery).fadeOut());
				};
			},
				...
				if (this.container.parent() && this.container.parent().width()) {
					...
					if (this.options.titlesmallscreen) {
						...
						this.options.titleheight =
							a < this.options.titlesmallscreenwidth
						...
						this.options.carouselmultirows
							? ('samecolumn' == this.options.thumbresponsive
									? ((this.options.carouselcolumn = this.options.thumbcolumns),
										...
										(this.options.thumbwidth = Math.min(
											(this.options.width -
												this.options.thumbgap * (this.options.carouselcolumn - 1)) /
									...
									: (this.options.thumbcolumnsresponsive &&
											...
											this.options.thumbshowtitle &&
												(this.options.thumbheight += this.options.thumbtitleheight)),
										(this.options.carouselcolumn = Math.floor(
											this.options.width / (this.options.thumbwidth + this.options.thumbgap)
										)),
										1 > this.options.carouselcolumn && (this.options.carouselcolumn = 1)),
								(this.options.carouselHeight =
									Math.ceil(this.elemArray.length / this.options.carouselcolumn) *
					...
					this.options.responsivefullscreen && 0 < this.container.parent().height()
						? ((this.options.containerHeight = this.container.parent().height()),
							...
							(this.options.height =
								this.options.totalHeight - (this.options.headerHeight + 2 * this.options.padding)),
							0 < this.options.carouselHeight + this.options.carouselmargin &&
					...
					this.options.showcarousel &&
						...
						(this.options.carouselLeft = this.options.padding),
						(this.options.carouselTop =
							'top' == this.options.carouselposition
								? this.options.padding
					...
					if (1 == a || this.showingPoster) {
						...
						if (this.isFullscreen)
							var a = this.elemArray[this.curElem][17]
									? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth)
									: this.fullscreenWidth,
								e = this.elemArray[this.curElem][18]
									? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight)
						...
						(d = this.elemArray[this.curElem][10]),
							...
							this.isFullscreen
								? ((a = this.elemArray[this.curElem][17]
									...
									(e = Math.round(a * d)),
									(a = Math.round(a * c)),
									this.adjustFullscreen(e, a, !0))
								: ((e = this.options.width), (a = this.options.height)),
							b('.html5gallery-elem-' + this.id).css({ width: e + 'px', height: a + 'px' }),
							b('.html5gallery-elem-video-' + this.id).css({ width: e + 'px', height: a + 'px' }),
							b('.html5gallery-elem-video-container-' + this.id).css({ width: '100%', height: '100%' }),
							b('.html5gallery-elem-video-container-' + this.id)
								.find('video')
								.css({ width: '100%', height: '100%' }),
							...
							b('#html5gallery-elem-video-' + this.id).find('iframe').attr('width', e),
							b('#html5gallery-elem-video-' + this.id).find('iframe').attr('height', a),
							b('.html5gallery-elem-iframe-' + this.id).css({ width: e + 'px', height: a + 'px' }),
					...
					if (this.options.showcarousel) {
						...
						Math.floor((this.options.width - 4 - 4) / (this.options.thumbwidth + this.options.thumbgap)) <
							this.elemArray.length && (this.options.carouselNavButton = !0);
						...
						this.options.thumbShowNum = Math.floor(
							(this.options.width - 4 - 4 - a) / (this.options.thumbwidth + this.options.thumbgap)
						);
						1 > this.options.thumbShowNum && (this.options.thumbShowNum = 1);
						...
						this.options.thumbTotalWidth =
							this.elemArray.length * this.options.thumbwidth +
							(this.elemArray.length - 1) * this.options.thumbgap;
						e = 0;
						this.options.carouselmultirows
							? ('samecolumn' == this.options.thumbresponsive
									...
									: ((a = Math.floor(
										...
										(e =
											(this.options.width -
												a * this.options.thumbwidth -
												(a - 1) * this.options.thumbgap) /
											2),
										b('.html5gallery-thumbs-' + this.id).css({
											'margin-left': e + 'px',
											width: this.options.width + 'px'
								...
								b('.html5gallery-tn-img-' + this.id).css({
									width:
										String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + 'px',
									height:
										String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + 'px'
								}),
							...
							: ((this.options.thumbShowNum = Math.floor(
								...
								(this.options.thumbTotalWidth =
									...
									(this.elemArray.length - 1) * this.options.thumbgap),
								(e = 0),
								this.options.thumbMaskWidth > this.options.thumbTotalWidth &&
									(e =
										this.options.thumbMaskWidth / 2 -
										this.options.thumbTotalWidth / 2 -
										this.options.thumbgap / 2),
								b('.html5gallery-car-' + this.id).css({ height: this.options.carouselHeight + 'px' }),
								b('.html5gallery-car-list-' + this.id).css({
									height: this.options.carouselHeight + 'px'
								}),
								b('.html5gallery-car-left-' + this.id).css({
								...
								b('.html5gallery-thumbs-' + this.id).css({
									...
									width:
										String(
											this.elemArray.length * (this.options.thumbwidth + this.options.thumbgap)
										) + 'px'
								}));
						var f = '100%',
							j = 'auto',
			...
			createStyleDefault: function() {
				...
				if ('samecolumn' == this.options.thumbresponsive) {
					...
					this.options.thumbwidth = Math.min(
						(this.options.width - this.options.thumbgap * (this.options.carouselcolumn - 1)) /
							this.options.carouselcolumn
					);
					this.options.thumbheight =
				...
				this.options.boxTop = this.options.padding;
				this.options.slideshadow &&
					((this.options.boxWidth += 8), (this.options.boxLeft -= 4), (this.options.boxTop -= 4));
				this.options.showcarousel
					? ((this.options.carouselWidth = this.options.width),
						(this.options.carouselHeight = this.options.thumbheight + 2 * this.options.thumbmargin),
						(this.options.carouselLeft = this.options.padding),
						'top' == this.options.carouselposition
							? ((this.options.carouselTop = this.options.padding),
								(this.options.boxTop =
									this.options.padding + this.options.carouselHeight + this.options.carouselmargin))
							: (this.options.carouselTop =
									this.options.padding + this.options.boxHeight + this.options.carouselmargin),
						this.options.carouselmultirows &&
							('samecolumn' == this.options.thumbresponsive
				...
				this.options.elemTop = 0;
				'top' == this.options.headerpos
					? ((d = 0), (c = this.options.socialheight), (this.options.elemTop = this.options.headerHeight))
					: 'bottom' == this.options.headerpos &&
						((this.options.elemTop = 0),
						(c = this.options.titleoverlay
							? this.options.height - this.options.titleheight
				...
				this.options.titleoverlay
					? (a =
							'top' == this.options.headerpos
								? a + 'top:0px; height:auto; }'
								: a + 'bottom:0px; height:auto; }')
					: ((a += 'top:' + c + 'px; height:' + this.options.titleheight + 'px; }'),
						this.options.titlesmallscreen &&
							(a +=
								' @media (max-width: ' +
								this.options.titlesmallscreenwidth +
								'px) { .html5gallery-title-' +
								this.id +
								' {height:' +
								this.options.titleheightsmallscreen +
								'px; }}'));
				...
				a +=
					...
					'px;}';
				this.options.isIE7 || this.options.isIE6
					? ((a += ' .html5gallery-loading-' + this.id + ' {display:none; }'),
						(a += ' .html5gallery-loading-center-' + this.id + ' {display:none; }'))
					: ((a +=
							' .html5gallery-loading-' +
							this.id +
							" {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" +
				...
				0 < this.options.borderradius &&
					(a +=
						...
						'px;}');
				this.options.slideshadow &&
					((a += ' .html5gallery-title-' + this.id + ' { padding:4px;}'),
				...
				this.options.showcarousel && this.options.carouselmultirows
					? ((a +=
							' .html5gallery-car-' +
							this.id +
							' { position:absolute; display:block; margin:10px; overflow:hidden; left:' +
							this.options.carouselLeft +
							'px; top:' +
							this.options.carouselTop +
							'px; width:' +
						...
						(a =
							...
							('.html5gallery-thumbs-' +
								...
								'px; width:' +
								('samecolumn' == this.options.thumbresponsive
									? (this.options.thumbwidth + this.options.thumbgap) * this.options.carouselcolumn
									: this.options.width) +
								'px; top:0px; }')),
						(a +=
							' .html5gallery-tn-' +
						...
						(a +=
							...
							String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) +
							'px;}'),
						this.options.thumbunselectedimagebordercolor &&
							(a +=
								' .html5gallery-tn-selected-' +
								this.id +
								' {background-color:' +
						...
						this.options.thumbshowtitle
							? ((a +=
									' .html5gallery-tn-title-' +
									this.id +
									' {display:block; overflow:hidden; float:top; height:' +
									this.options.thumbtitleheight +
									'px;width:' +
									String(this.options.thumbwidth - 2) +
									'px;}'),
								(a += ' .html5gallery-tn-title-' + this.id + this.options.thumbtitlecss))
							: (a += ' .html5gallery-tn-title-' + this.id + ' {display:none;}'),
					...
					: this.options.showcarousel
						? ((a +=
							...
							(a +=
								' .html5gallery-car-list-' +
								this.id +
								' { position:absolute; display:block;margin:10px; overflow:hidden; left:4px; width:' +
								String(this.options.width - 4 - 4) +
								'px; top:0px; height:' +
								this.options.carouselHeight +
								'px; }'),
							(this.options.carouselNavButton = !1),
							...
							(a +=
								' .html5gallery-car-left-' +
								this.id +
								' { position:absolute;margin:10px; overflow:hidden; width:' +
								...
								"px; background:url('" +
								this.options.skinfolder +
								"carousel_left.png') no-repeat 0px 0px;}  .html5gallery-car-right-" +
								this.id +
							...
							(this.options.thumbShowNum = Math.floor(
								(this.options.width - 4 - 4 - c) / (this.options.thumbwidth + this.options.thumbgap)
							)),
							1 > this.options.thumbShowNum && (this.options.thumbShowNum = 1),
							(this.options.thumbMaskWidth =
								this.options.thumbShowNum * this.options.thumbwidth +
							...
							(a +=
								' .html5gallery-car-mask-' +
								this.id +
								' { position:absolute; display:block; text-align:left; overflow:hidden; left:' +
								c +
								'px; width:' +
								this.options.thumbMaskWidth +
								'px; top:0px; height:' +
							...
							(this.carouselHighlight = function(a, c) {
								...
								if (this.options.thumbShowNum >= this.elemArray.length)
									...
									d = -d;
									c
										? b('.html5gallery-thumbs-' + this.id, this.$gallery).css({ marginLeft: d })
							...
							(this.carouselNext = function() {
								...
								if (
									...
									-(this.options.thumbTotalWidth - this.options.thumbMaskWidth + this.options.thumbgap)
								) {
									var c =
										-1 * parseInt(a.css('margin-left')) +
										this.options.thumbShowNum * (this.options.thumbwidth + this.options.thumbgap);
			...
			loadCarousel: function() {
				...
				for (var d = 0; d < this.elemArray.length; d++) {
					...
					e.hover(
						...
						function() {
							b(this).data('index') !== a.curElem &&
								b(this)
									.removeClass('html5gallery-tn-selected-' + a.id)
									.addClass('html5gallery-tn-' + a.id);
						}
					);
					e = new Image();
					e.data = d;
					b(e).on('load', function() {
						...
						a.options.carouselmultirows && 'samecolumn' == a.options.thumbresponsive
							? b('#html5gallery-tn-' + a.id + '-' + this.data, c).append(
									"<div class='html5gallery-tn-img-" +
										...
										a.options.thumbimageborder +
										"px;'><img alt='" +
										a.html2Text(a.elemArray[this.data][25]) +
										"'" +
										(a.options.addimgtitle
											? " title='" + a.html2Text(a.elemArray[this.data][7]) + "'"
											: '') +
										' data-originalwidth=' +
										this.width +
										' data-originalheight=' +
										...
										d +
										"px;' src='" +
										a.elemArray[this.data][1] +
										"' /></div>" +
										h +
										"</div><div class='html5gallery-tn-title-" +
										a.id +
										"' style='width:" +
										String(a.options.thumbwidth - 2) +
										"px;'>" +
										a.elemArray[this.data][7] +
										(a.options.thumbshowdescription
						...
						a.options.thumblinkintitle &&
							((e = b('.html5gallery-tn-img-' + a.id, c)),
							e.off('click').click(function() {
			...
			goNormal: function() {
				...
				if (0 < b('.html5gallery-elem-' + this.id, this.$fullscreen).length) {
					var a = b('.html5gallery-elem-' + this.id, this.$fullscreen)
						.empty()
				...
				'show' == this.options.imagetoolboxmode
					? this.showimagetoolbox(this.elemArray[this.curElem][9])
			...
			goFullscreen: function() {
				...
				this.fullscreenHeight =
					e - 2 * this.fullscreenMargin - this.fullscreenBarH - 2 * this.fullscreenOutsideMargin;
				var f = Math.max(e, b(document).height()),
					j = this.elemArray[this.curElem][17]
						? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth)
						: this.fullscreenWidth,
					l = this.elemArray[this.curElem][18]
						? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight)
						: this.fullscreenHeight,
					j = Math.min(j / c, l / d);
				1 > j && ((c *= j), (d *= j));
				...
				this.$fullscreen = b(
					"<div class='html5gallery-fullscreen-" +
						...
						'px;height:' +
						f +
						"px;text-align:center;z-index:99999;'><div class='html5gallery-fullscreen-overlay-" +
						this.id +
						"' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:#000000;opacity:0.9;filter:alpha(opacity=80);'></div><div class='html5gallery-fullscreen-box-" +
						this.id +
						...
						'px;height:' +
						this.fullscreenInitial +
						"px;'><div class='html5gallery-fullscreen-elem-" +
						this.id +
						"' style='display:block;position:relative;overflow:hidden;width:" +
						String(c + 2 * this.fullscreenMargin) +
						'px;height:' +
						String(d + 2 * this.fullscreenMargin) +
						'px;background-color:' +
						...
						String(d - 4) +
						"px; left:0px; width:0px; height:4px; background-color:#666; filter:alpha(opacity=60); opacity:0.6;'></div></div></div><div class='html5gallery-fullscreen-bar-" +
						this.id +
						...
						'px ' +
						this.fullscreenMargin +
						"px;'><div class='html5gallery-fullscreen-close-" +
						this.id +
						"' style='display:block;position:relative;float:right;cursor:pointer;width:32px;height:32px;top:0px;background-image:url(\"" +
						this.options.skinfolder +
						"lightbox_close.png\");'></div><div class='html5gallery-fullscreen-play-" +
						this.id +
						"' style='display:" +
						(this.isPaused && 1 < this.elemArray.length && 1 == this.elemArray[this.curElem][9]
							? 'block'
							: 'none') +
						';position:relative;float:right;cursor:pointer;width:32px;height:32px;top:0px;background-image:url("' +
						this.options.skinfolder +
						"lightbox_play.png\");'></div><div class='html5gallery-fullscreen-pause-" +
						this.id +
						"' style='display:" +
						(this.isPaused || 1 >= this.elemArray.length || 1 != this.elemArray[this.curElem][9]
							? 'none'
						...
						';position:relative;float:right;cursor:pointer;width:32px;height:32px;top:0px;background-image:url("' +
						this.options.skinfolder +
						"lightbox_pause.png\");'></div><div class='html5gallery-fullscreen-title-" +
						this.id +
						"' style='display:block;position:relative;float:left;width:" +
						String(c - 2 * this.fullscreenMargin - 72) +
						"px;height:auto;top:0px;left:0px;text-align:left;'></div><div style='clear:both;'></div></div></div><div class='html5gallery-fullscreen-next-" +
						this.id +
						...
						this.options.skinfolder +
						"lightbox_next.png\");'></div><div class='html5gallery-fullscreen-prev-" +
						this.id +
					...
					function() {
						b(this).animate({ width: c + 2 * g.fullscreenMargin }, 'slow', function() {
							b(this).animate({ height: '+=' + g.fullscreenBarH }, 'slow', function() {
								if (g.isFullscreen) {
									var a = b('.html5gallery-elem-' + g.id, g.$gallery)
										.empty()
										.css({ top: 0, position: 'relative' });
									b('.html5gallery-fullscreen-elem-wrapper-' + g.id, g.$fullscreen).prepend(a);
									g.slideRun(g.curElem);
									g.options.showsocial &&
										b('.html5gallery-fullscreen-social-' + g.id, g.$fullscreen).show();
								}
							});
						});
					}
				...
				b('.html5gallery-fullscreen-box-' + this.id, this.$fullscreen).hover(
					function() {
						1 < g.elemArray.length &&
				...
				g.options.enabletouchswipe &&
					((a = g.options.isAndroid && g.options.enabletouchswipeonandroid ? !0 : !1),
				...
				b('.html5gallery-fullscreen-play-' + this.id, this.$fullscreen).click(function() {
					...
					g.isPaused = !1;
					g.slideshowTimeout.setInterval(
				...
				b(document).on('keyup.html5gallery', function(a) {
					27 == a.keyCode
						? g.goNormal()
						: 39 == a.keyCode ? g.slideRun(-1) : 37 == a.keyCode && g.slideRun(-2);
				});
			},
			...
			showSlideTimer: function() {
				var a = this.elemArray[this.curElem][16]
					? this.elemArray[this.curElem][16]
					: this.options.slideshowinterval;
				this.slideTimerCount++;
				this.isFullscreen
					? b('.html5gallery-fullscreen-timer-' + this.id, this.$fullscreen).width(
							Math.round(
								50 *
									b('.html5gallery-fullscreen-elem-wrapper-' + this.id, this.$fullscreen).width() *
									(this.slideTimerCount + 1) /
									a
							)
						)
					: b('.html5gallery-timer-' + this.id, this.$gallery).width(
							Math.round(50 * this.options.boxWidth * (this.slideTimerCount + 1) / a)
						);
			},
			setHd: function(a, b) {
			...
			slideRun: function(a, c, d, e) {
				...
				this.options.showcarousel &&
					0 <= this.curElem &&
					b('#html5gallery-tn-' + this.id + '-' + this.curElem, this.$gallery)
						.removeClass('html5gallery-tn-selected-' + this.id)
						.addClass('html5gallery-tn-' + this.id);
				this.calcIndex(a);
				this.isFullscreen
					? (this.$fullscreen.addClass('html5gallery-fullscreen-activeslide-' + this.id + '-' + this.curElem),
						0 <= this.prevElem &&
							this.$fullscreen.removeClass(
								'html5gallery-fullscreen-activeslide-' + this.id + '-' + this.prevElem
							))
					: (this.$gallery.addClass('html5gallery-activeslide-' + this.id + '-' + this.curElem),
						0 <= this.prevElem &&
							this.$gallery.removeClass('html5gallery-activeslide-' + this.id + '-' + this.prevElem));
				this.options.arrowloop ||
					(this.isFullscreen
				...
				!this.isFullscreen &&
					...
					(b('#html5gallery-tn-' + this.id + '-' + this.curElem, this.$gallery)
						.removeClass('html5gallery-tn-' + this.id)
						.addClass('html5gallery-tn-selected-' + this.id),
					!this.options.notupdatecarousel &&
				...
				if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
					...
					this.options.shownumbering &&
						(a =
							this.options.numberingformat
								.replace('%NUM', this.curElem + 1)
					...
					if (this.isFullscreen) {
						...
						this.options.lightboxshowdescription &&
							f &&
							(j += "<div class='html5gallery-fullscreen-description-" + this.id + "'>" + f + '</div>');
						...
						this.options.showtitle &&
							...
							this.options.showdescription &&
								f &&
								(j += "<div class='html5gallery-description-text-" + this.id + "'>" + f + '</div>'),
							b('.html5gallery-title-' + this.id, this.$gallery).html(j));
					(!this.options.titleoverlay || !this.options.titleautohide) &&
						b('.html5gallery-title-' + this.id, this.$gallery).show();
				}
				a = this.elemArray[this.curElem][9];
				if (!(0 > a)) {
					!this.isFullscreen && c
						? 'always' == this.options.showimagetoolbox
							? ('mouseover' == this.options.imagetoolboxmode || 'show' == this.options.imagetoolboxmode) &&
								this.showimagetoolbox(a)
							: 'image' == this.options.showimagetoolbox && 1 != a && this.hideimagetoolbox()
					...
					!d &&
					this.elemArray[this.curElem][12]
						? ((this.showingPoster = !0), this.showPoster())
						: (b('.html5gallery-video-play-' + this.id, l).length &&
								b('.html5gallery-video-play-' + this.id, l).remove(),
							1 == a
								? this.showImage()
								: (this.options.hidetitlewhenvideoisplaying &&
										b('.html5gallery-title-' + this.id, l).hide(),
									5 == a || 6 == a || 7 == a || 8 == a
										? this.showVideo(d, e)
										: 9 == a
											? this.showYoutube(d)
											: 10 == a
												? this.showVimeo(d)
												: 11 == a
													? this.showEmbedVideo(d)
													: 2 == a ? this.showSWF() : 12 == a && this.showIframe()));
					this.checkMK();
					this.prevElem in this.elemArray &&
						1 == this.elemArray[this.prevElem][9] &&
						(new Image().src = this.elemArray[this.prevElem][2]);
					this.nextElem in this.elemArray &&
						1 == this.elemArray[this.nextElem][9] &&
						(new Image().src = this.elemArray[this.nextElem][2]);
					this.prevElem in this.elemArray &&
						(!this.options.autoplayvideo && this.elemArray[this.prevElem][12]) &&
						(new Image().src = this.elemArray[this.prevElem][12]);
					this.nextElem in this.elemArray &&
						(!this.options.autoplayvideo && this.elemArray[this.nextElem][12]) &&
						(new Image().src = this.elemArray[this.nextElem][12]);
					this.curElem == this.elemArray.length - 1 && this.looptimes++;
					var g = this;
					if (
						(1 == a || this.showingPoster) &&
						!this.isPaused &&
						1 < this.elemArray.length &&
						(!this.options.loop || this.looptimes < this.options.loop)
					)
						(e = this.elemArray[this.curElem][16]
							? this.elemArray[this.curElem][16]
							: this.options.slideshowinterval),
							this.firstrun &&
								this.options.setfirstslideshowinterval &&
								(e = this.options.firstslideshowinterval),
					...
					this.options.loop &&
						...
						((this.looptimes = 0), this.pauseGallery());
					a = this.elemArray[this.curElem][9];
					(this.elemArray[this.curElem][5] ||
						((this.options.lightbox || this.elemArray[this.curElem][22]) && !this.isFullscreen)) &&
					(!this.options.linkonlyonvideo || !(5 == a || 6 == a || 7 == a || 8 == a))
						? (c.css({ cursor: 'pointer' }),
							c.off('click').on('click', function() {
								(g.options.lightbox || g.elemArray[g.curElem][22]) && !g.isFullscreen
									? g.goFullscreen()
									: g.elemArray[g.curElem][5] &&
										(g.elemArray[g.curElem][6]
											? window.open(g.elemArray[g.curElem][5], g.elemArray[g.curElem][6])
											: window.open(g.elemArray[g.curElem][5]));
							}))
			...
			showImage: function() {
				...
				$preloading =
					'' === a.html()
						? b("<div class='html5gallery-loading-center-" + this.id + "'></div>").appendTo(a)
						: b("<div class='html5gallery-loading-" + this.id + "'></div>").appendTo(a);
				var c = this,
					d = new Image();
				b(d).on('load', function() {
					...
					e = b(
						"<div class='html5gallery-elem-img-" +
							...
							(c.options.slideshadow && !c.isFullscreen ? 4 : 0) +
							'px; top:0px; margin-top:' +
							(c.options.slideshadow && !c.isFullscreen ? 4 : 0) +
							"px;'><img alt='" +
							c.html2Text(c.elemArray[c.curElem][25]) +
							"'" +
							(c.options.addimgtitle ? " title='" + c.html2Text(c.elemArray[c.curElem][7]) + "'" : '') +
							...
							"' />" +
							c.options.watermarkcode +
							'</div>'
					);
					d = b('.html5gallery-elem-img-' + c.id, a);
					d.length
						? (a.prepend(e),
							a.html5boxTransition(
								c.id,
								d,
								e,
								{
					...
					c.options.googleanalyticsaccount &&
						window._gaq &&
						window._gaq.push([ '_trackEvent', 'Image', 'Play', c.elemArray[c.curElem][2] ]);
					c.checkMK();
				});
				b(d).on('error', function() {
					...
					a.html(
						"<div class='html5gallery-elem-error-" +
							...
							c.options.width +
							'px; left:0px; top:' +
							Math.round(c.options.height / 2 - 10) +
					...
					c.options.googleanalyticsaccount &&
						window._gaq &&
						window._gaq.push([ '_trackEvent', 'Image', 'Error', c.elemArray[c.curElem][2] ]);
				});
			...
			adjustFullscreen: function(a, c, d) {
				...
				var j = Math.max(f, b(document).height()),
					l = this.elemArray[this.curElem][17]
						? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth)
						: this.fullscreenWidth,
				...
				d
					? (b('.html5gallery-fullscreen-box-' + this.id, this.$fullscreen).css({
				...
				b('.html5gallery-fullscreen-play-' + this.id, this.$fullscreen).css(
					'display',
					this.isPaused && 1 < this.elemArray.length && 1 == this.elemArray[this.curElem][9]
						? 'block'
						: 'none'
				);
				b('.html5gallery-fullscreen-pause-' + this.id, this.$fullscreen).css(
					'display',
					this.isPaused || 1 >= this.elemArray.length || 1 != this.elemArray[this.curElem][9]
						? 'none'
						: 'block'
				...
				b('.html5gallery-elem-video-container-' + this.id, this.$fullscreen)
					.find('video')
					.css({ width: '100%', height: '100%' });
				b('#html5gallery-elem-video-' + this.id, this.$fullscreen).css({ width: a + 'px', height: c + 'px' });
			...
			showPoster: function() {
				...
				$preloading =
					'' === c.html()
						? b("<div class='html5gallery-loading-center-" + this.id + "'></div>").appendTo(c)
						: b("<div class='html5gallery-loading-" + this.id + "'></div>").appendTo(c);
				var d = this,
				...
				b(j).on('load', function() {
					...
					var j, g, k;
					d.isFullscreen
						? ((g = d.elemArray[d.curElem][17]
								? Math.min(d.elemArray[d.curElem][17], d.fullscreenWidth)
								: Math.min(e, d.fullscreenWidth)),
							(k = d.elemArray[d.curElem][18]
								? Math.min(d.elemArray[d.curElem][18], d.fullscreenHeight)
								: Math.min(f, d.fullscreenHeight)),
							(j = Math.max(g / this.width, k / this.height)),
							(j = 1 < j ? 1 : j))
						: ((j =
								'fill' == d.options.resizemode
									? Math.max(d.options.width / this.width, d.options.height / this.height)
									: Math.min(d.options.width / this.width, d.options.height / this.height)),
							(g = d.options.width),
							(k = d.options.height));
					...
					g = b(
						"<div class='html5gallery-elem-img-" +
							...
							k +
							'px; left:0px; margin-left:' +
							(d.options.slideshadow && !d.isFullscreen ? 4 : 0) +
							'px; top:0px; margin-top:' +
							(d.options.slideshadow && !d.isFullscreen ? 4 : 0) +
							"px;'><img alt='" +
							d.html2Text(d.elemArray[d.curElem][25]) +
							"'" +
							(d.options.addimgtitle ? " title='" + d.html2Text(d.elemArray[d.curElem][7]) + "'" : '') +
							" class='html5gallery-elem-image html5gallery-elem-image-" +
							d.id +
							"' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" +
							q +
							...
							j +
							"px;' src='" +
							d.elemArray[d.curElem][12] +
							"' />" +
							d.options.watermarkcode +
							'</div>'
					);
					k = b('.html5gallery-elem-img-' + d.id, c);
					k.length
						? (c.prepend(g),
							c.html5boxTransition(
								d.id,
								k,
								g,
								{
					...
					if (!b('.html5gallery-video-play-' + d.id, a).length)
						b(
							"<div class='html5gallery-video-play-" +
								...
								d.options.playvideoimage +
								'") no-repeat center center;\'></div>'
						)
							.appendTo(c)
							.off(d.eClick)
							.on(d.eClick, function() {
								...
								5 == a || 6 == a || 7 == a || 8 == a
									...
									: 9 == a
										? d.showYoutube(!0)
										: 10 == a ? d.showVimeo(!0) : 11 == a && d.showEmbedVideo(!0);
								d.checkMK();
							});
					d.checkMK();
				});
				b(j).on('error', function() {
					...
					c.html(
						"<div class='html5gallery-elem-error-" +
							...
							d.options.width +
							'px; left:0px; top:' +
							Math.round(d.options.height / 2 - 10) +
							"px; margin:4px;'><div class='html5gallery-error-" +
							d.id +
							"'>The requested content cannot be found</div>"
					);
					d.options.googleanalyticsaccount &&
						window._gaq &&
						window._gaq.push([ '_trackEvent', 'Image', 'Error', d.elemArray[d.curElem][12] ]);
				});
			...
			playVideo: function() {
				...
				if (5 == a || 6 == a || 7 == a || 8 == a)
					this.isHTML5 && 0 < b('#html5gallery-elem-html5-video-' + this.id).length
						? b('#html5gallery-elem-html5-video-' + this.id, this.container).get(0).play()
						: (a = this.getFlashMovieObject('html5gallery-elem-video-flash-' + this.id)) &&
							'function' === typeof a.playVideo &&
							a.playVideo();
			},
						...
						if (html5GalleryObjects.objects[a].id != this.id)
							try {
								html5GalleryObjects.objects[a].ytPlayer &&
									'function' == typeof html5GalleryObjects.objects[a].ytPlayer.pauseVideo &&
									html5GalleryObjects.objects[a].ytPlayer.pauseVideo(),
			...
			pauseVideo: function() {
				...
				5 == a || 6 == a || 7 == a || 8 == a
					? this.isHTML5 && 0 < b('#html5gallery-elem-html5-video-' + this.id).length
						? b('#html5gallery-elem-html5-video-' + this.id, this.container).get(0).pause()
						: (a = this.getFlashMovieObject('html5gallery-elem-video-flash-' + this.id)) &&
							'function' === typeof a.pauseVideo &&
							a.pauseVideo()
					: 9 == a
						? this.ytPlayer && 'function' == typeof this.ytPlayer.pauseVideo && this.ytPlayer.pauseVideo()
						: 10 == a
							? this.vimeoPlayer && this.vimeoPlayer.api('pause')
							: b('video', this.container).length && b('video', this.container).get(0).pause();
			},
			showVideo: function(a, c) {
				...
				if (this.isFullscreen) {
					var e = this.elemArray[this.curElem][17]
							? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth)
							: Math.min(e, this.fullscreenWidth),
				...
				j = -1;
				c &&
					b('.html5gallery-elem-' + this.id, d).find('video').length &&
					(j = b('.html5gallery-elem-' + this.id, d).find('video:first').get(0).currentTime);
				b('.html5gallery-elem-' + this.id, d).html(
				...
				if (
					this.options.isIE678 ||
					(this.options.isIE9 && this.options.useflashonie9) ||
					(this.options.isIE10 && this.options.useflashonie10) ||
					(this.options.isIE11 && this.options.useflashonie11)
				)
					this.isHTML5 = !1;
					...
					if (((this.isHTML5 = !0), this.options.isFirefox || this.options.isOpera))
						if (
							!this.elemArray[this.curElem][4] &&
							!this.elemArray[this.curElem][3] &&
							(!this.options.canplaymp4 || this.options.useflashformp4onfirefox)
						)
							this.isHTML5 = !1;
				if (this.isHTML5) {
					...
					if (this.options.isFirefox || this.options.isOpera)
						this.elemArray[this.curElem][4]
							? (l = this.elemArray[this.curElem][4])
							: this.elemArray[this.curElem][3] && (l = this.elemArray[this.curElem][3]),
							this.elemArray[this.curElem][15]
								? (g = this.elemArray[this.curElem][15])
								: this.elemArray[this.curElem][14] && (g = this.elemArray[this.curElem][14]);
					this.embedHTML5Video(b('.html5gallery-elem-video-' + this.id, d), f, e, l, g, a, j, c);
				} else
					(j = this.elemArray[this.curElem][2]),
						'/' != j.charAt(0) &&
							('http:' != j.substring(0, 5) && 'https:' != j.substring(0, 6)) &&
							(j = this.options.htmlfolder + j),
						(l = ''),
						this.elemArray[this.curElem][13] &&
							((l = this.elemArray[this.curElem][13]),
							'/' != l.charAt(0) &&
								('http:' != l.substring(0, 5) && 'https:' != l.substring(0, 6)) &&
								(l = this.options.htmlfolder + l)),
						(f = {
							width: f,
							height: e,
						...
						this.elemArray[this.curElem][5] &&
							((f.clickthrough = this.elemArray[this.curElem][5]),
							this.elemArray[this.curElem][6] &&
								(f.clickthroughtarget = this.elemArray[this.curElem][6])),
						this.embedFlash(
							b('.html5gallery-elem-video-' + this.id, d),
							'100%',
							'100%',
			...
			showSWF: function() {
				...
				var e = this.isFullscreen
						? 0
						: Math.round((this.options.height - d) / 2) + (this.options.slideshadow ? 4 : 0),
					f = this.isFullscreen
						? 0
						: Math.round((this.options.width - c) / 2) + (this.options.slideshadow ? 4 : 0);
				b('.html5gallery-elem-' + this.id, a).html(
					"<div class='html5gallery-elem-flash-" +
						this.id +
						"' style='display:block;position:absolute;overflow:hidden;top:" +
						e +
						'px;left:' +
				...
				this.embedFlash(
					b('.html5gallery-elem-flash-' + this.id, a),
					c,
					d,
					this.elemArray[this.curElem][2],
					'window',
					{},
					'html5gallery-elem-flash-object-' + this.id
				);
				this.options.googleanalyticsaccount &&
					window._gaq &&
					window._gaq.push([ '_trackEvent', 'Flash', 'Play', this.elemArray[this.curElem][2] ]);
			},
			prepareYoutubeHref: function(a) {
				var b = a.match(/(\?v=|\/\d\/|\/embed\/|\/v\/|\.be\/)([a-zA-Z0-9\-\_]+)/)[2],
					b =
						'https://www.' +
						(-1 !== a.indexOf('youtube-nocookie.com') ? 'youtube-nocookie.com' : 'youtube.com') +
						'/embed/' +
						b;
			...
			initYoutubeApi: function() {
				...
				for (a = 0; a < this.elemArray.length; a++)
					9 == this.elemArray[a][9] && -1 === this.elemArray[a][2].indexOf('youtube-nocookie.com')
						? (b = !0)
						: 10 == this.elemArray[a][9] && (d = !0);
				b &&
			...
			showEmbedVideo: function(a) {
				...
				if (this.isFullscreen) {
					var d = this.elemArray[this.curElem][17]
							? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth)
							: Math.min(d, this.fullscreenWidth),
						f = this.elemArray[this.curElem][18]
							? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight)
				...
				b('.html5gallery-elem-' + this.id, c).html(
					"<div class='html5gallery-loading-center-" +
						this.id +
				...
				f.match(/\:\/\/.*(dai\.ly)/i) &&
					(f = 'https://www.dailymotion.com/embed/video/' + f.match(/(dai\.ly\/)([a-zA-Z0-9\-\_]+)/)[2]);
				a && (f = 0 > f.indexOf('?') ? f + '?autoplay=1' : f + '&autoplay=1');
				b('#html5gallery-elem-video-' + this.id, c).html(
					"<iframe width='" +
						e +
						"' height='" +
						d +
			...
			showYoutube: function(a) {
				...
				ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7 && !j
					? ((c = this.elemArray[this.curElem][2].match(
			...
			showVimeo: function(a) {
				...
				b('.html5gallery-elem-video-' + this.id, d).html(
					"<iframe id='html5gallery_vimeo_" +
						this.id +
						"' width='" +
						f +
						"' height='" +
				...
				'function' === typeof $f &&
					(a && !this.options.isAndroid) &&
					((d = b('#html5gallery_vimeo_' + this.id)[0]),
					(c = this),
					(c.vimeoPlayer = $f(d)),
			...
			showIframe: function() {
				...
				if (this.isFullscreen) {
					var c = this.elemArray[this.curElem][17]
							? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth)
							: Math.min(c, this.fullscreenWidth),
						e = this.elemArray[this.curElem][18]
							? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight)
							: Math.min(d, this.fullscreenHeight);
				...
				b('.html5gallery-elem-iframe-' + this.id, a).html(
					"<iframe id='html5gallery-iframe-" +
						this.id +
						"' width='" +
						d +
						"' height='" +
				...
				this.options.googleanalyticsaccount &&
					window._gaq &&
					window._gaq.push([ '_trackEvent', 'Iframe', 'Play', this.elemArray[this.curElem][2] ]);
			},
			checkType: function(a) {
				return !a
					? -1
					: a.match(/\.(jpg|gif|png|bmp|jpeg)(.*)?$/i)
						? 1
						: a.match(/[^\.]\.(swf)\s*$/i)
							? 2
							: a.match(/[^\.]\.(mp3)\s*$/i)
									...
									: a.match(/\.(flv)(.*)?$/i)
										...
										: a.match(/\.(mp4|m4v)(.*)?$/i)
											...
											: a.match(/\.(ogv|ogg)(.*)?$/i)
												...
												: a.match(/\.(webm)(.*)?$/i)
													? 8
													: a.match(/\:\/\/.*(youtube\.com)/i) ||
														a.match(/\:\/\/.*(youtu\.be)/i) ||
														a.match(/\:\/\/.*(youtube-nocookie\.com)/i)
														? 9
														: a.match(/\:\/\/.*(vimeo\.com)/i)
															? 10
															: a.match(/\:\/\/.*(dailymotion\.com)/i) || a.match(/\:\/\/.*(dai\.ly)/i)
																? 11
																: 1;
			},
			onChange: function() {
			...
			onThumbOver: function(a) {
				...
				if (
					this.options.onthumbover &&
					window[this.options.onthumbover] &&
					'function' == typeof window[this.options.onthumbover]
				)
			...
			onThumbClick: function(a) {
				...
				if (
					this.options.onthumbclick &&
					window[this.options.onthumbclick] &&
					'function' == typeof window[this.options.onthumbclick]
				)
					window[this.options.onthumbclick](this.elemArray[a].concat([ this.id ]));
				this.options.thumbjumptotop &&
					(this.options.thumbjumpanchor &&
					0 < this.options.thumbjumpanchor.length &&
					0 < b('#' + this.options.thumbjumpanchor).length
						? ((a = b('#' + this.options.thumbjumpanchor).offset().top), b(window).scrollTop(a))
						: 0 <= this.options.thumbjumpposition
							? b(window).scrollTop(this.options.thumbjumpposition)
			...
			onVideoEnd: function() {
				...
				this.options.reloadonvideoend
					? this.slideRun(this.curElem)
					: this.options.loadnextonvideoend && this.slideRun(-1);
			},
			embedHTML5Video: function(a, c, d, e, f, j, l, g) {
				...
				a.html(
					"<div class='html5gallery-elem-video-container-" +
						...
						(this.options.donotuseposter &&
						this.options.showhtml5videoposter &&
						this.elemArray[this.curElem][12]
							? ' poster="' + this.elemArray[this.curElem][12] + '"'
							: '') +
						'>' +
				...
				!this.options.nativehtml5controls &&
					...
					(b('video', a).data('src', e),
					b('video', a).data('hd', f),
					b('video', a).data('ishd', this.isHd),
					b('video', a).addHTML5VideoControls(
						this.options.skinfolder,
						this,
						...
						null,
						this.elemArray[this.curElem][ELEM_VTT] ? !0 : !1,
						this.options.vttline,
						this.options.showsubtitlebydefault
					));
				this.elemArray[this.curElem][5] &&
					(b('video', a).css({ cursor: 'pointer' }),
					b('video', a).off('click').on('click', function() {
						k.elemArray[k.curElem][5] &&
							(k.elemArray[k.curElem][6]
								? window.open(k.elemArray[k.curElem][5], k.elemArray[k.curElem][6])
				...
				if (this.options.flashInstalled) {
					...
					a.html(
						"<div class='html5gallery-elem-error-" +
							...
							"px;'><div class='html5gallery-error-" +
							this.id +
							"'><div>The required Adobe Flash Player plugin is not installed</div><div style='display:block;position:relative;text-align:center;width:112px;height:33px;margin:0px auto;'><a href='http://www.adobe.com/go/getflashplayer'><img src='http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif' alt='Get Adobe Flash player' width='112' height='33'></img></a></div></div>"
					);
			}
		};
		this.each(function() {
			...
			if ((!b(this).data('donotinit') || (k && k.forceinit)) && !b(this).data('inited')) {
				...
				var h = {
					...
					f = {
						...
						thumbshowtitle: !0,
						thumbtitlecss:
							'{text-align:center; color:#000; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden;}',
						thumbtitleheight: 24
					},
					j = {
						padding: 12,
						...
						titleautohide: !1,
						titlecss:
							' {color:#ffffff; font-size:20px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:10px 0px;}',
						titlecsslink: ' a {color:#ffffff;}',
						descriptioncss:
							' {color:#ffffff; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:0px 0px 10px 0px;}',
						descriptioncsslink: ' a {color:#ffffff;}',
						showcarousel: !0,
						carouselmargin: 10,
						carouselbgtransparent: !0,
						...
						thumbshowtitle: !0,
						thumbtitlecss:
							'{text-align:center; color:#000; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}',
						thumbtitleheight: 18
					...
					l = {
						...
						titleautohide: !0,
						titlecss:
							'{color:#333;font-size:14px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:16px 8px 4px 8px;}',
						titlecsslink: 'a{color:#333;}',
						descriptioncss:
							'{color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;overflow:hidden;text-align:center;padding:4px 8px; }',
					...
					s = {
						...
						titleautohide: !1,
						titlecss:
							' {color:#333; font-size:16px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:10px 0px;}',
						titlecsslink: ' a {color:#333;}',
						descriptioncss:
							' {color:#333; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:0px 0px 10px 0px;}',
						descriptioncsslink: ' a {color:#333;}',
						showcarousel: !0,
						carouselmargin: 8,
						...
						thumbshowtitle: !0,
						thumbtitlecss:
							'{text-align:center; color:#333; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}'
					},
					u = b.extend({}, s, { carouselposition: 'left' }),
					x = {
						...
						thumbshowtitle: !0,
						thumbtitlecss:
							'{text-align:center; color:#ffffff; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal;}'
					},
					z = b.extend({}, x, { carouselposition: 'left' }),
					O = {
						...
						thumbshowtitle: !0,
						thumbtitlecss:
							'{text-align:left; color:#ffffff; font-size:12px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; padding: 6px 0;}',
					...
					y = {
						...
						lightboxshowtitle: !0,
						lightboxtitlecss:
							' {color:#333333; font:bold 12px Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; line-height:18px;}',
						lightboxtitlelinkcss: ' a {color:#333333;}',
						lightboxshowdescription: !0,
						lightboxdescriptioncss:
							' {color:#333333; font:normal 12px Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; line-height:14px;}',
							...
							: 'verticalwithleft' == this.options.skin
								...
								: 'verticallight' == this.options.skin
									...
									: 'verticallightwithleft' == this.options.skin
										...
										: 'showcase' == this.options.skin
											? b.extend(y, O)
											: 'light' == this.options.skin
												? b.extend(y, h)
												: 'gallery' == this.options.skin
													? b.extend(y, j)
													: 'gallerywithtext' == this.options.skin
														? b.extend(y, l)
														: 'gallerywithtopthumbs' == this.options.skin
															? b.extend(y, g)
															: 'gallerywithtextbottom' == this.options.skin
																? b.extend(y, p)
																: 'horizontal' == this.options.skin
																	? b.extend(y, c)
																	: 'darkness' == this.options.skin
																		? b.extend(y, q)
																		: 'mediapage' == this.options.skin ? b.extend(y, f) : b.extend(y, c);
				...
				'/' != this.options.skinfolder.charAt(0) &&
					('http:' != this.options.skinfolder.substring(0, 5) &&
						'https:' != this.options.skinfolder.substring(0, 6)) &&
				...
				for (c = 0; c < h.length; c++)
					this.options[h[c]] &&
						(0 < this.options[h[c]].length &&
							'http://' != this.options[h[c]].substring(0, 7).toLowerCase() &&
							'https://' != this.options[h[c]].substring(0, 8).toLowerCase()) &&
						(this.options[h[c]] = this.options.skinfolder + this.options[h[c]]);
				h = '';
				...
				h = f.length;
				for (c = 0; 5 > c; c++) f = f.slice(0, h - 9 + c) + f.slice(h - 8 + c);
				-1 != this.options.htmlfolder.indexOf(f) && (this.options.frve = !1);
				h = b(window).width();
				if (this.options.screenquery)
					for (c in this.options.screenquery)
						h <= this.options.screenquery[c].screenwidth &&
							(this.options.screenquery[c].gallerywidth &&
								(this.options.width = this.options.screenquery[c].gallerywidth),
							this.options.screenquery[c].galleryheight &&
								(this.options.height = this.options.screenquery[c].galleryheight),
							this.options.screenquery[c].thumbwidth &&
								(this.options.thumbwidth = this.options.screenquery[c].thumbwidth),
				...
				'undefined' !== typeof html5GalleryObjects &&
...
function HTML5GallerySWFObjectFunc() {
					...
					if (l)
						if (a(L[c].swfVersion) && !(n.wk && 312 > n.wk))
							...
							for (var m = {}, l = l.getElementsByTagName('param'), q = l.length, r = 0; r < q; r++)
								'movie' != l[r].getAttribute('name').toLowerCase() &&
									(m[l[r].getAttribute('name')] = l[r].getAttribute('value'));
							z(h, m, g, j);
						} else p(l), j && j(h);
				} else if ((d(g, !0), j)) {
	...
	function z(a, c, d, j) {
		...
		if (h) {
			...
			j =
				'MMredirectURL=' +
				w.location.toString().replace(/&/g, '%26') +
				'&MMplayerType=' +
				j +
				'&MMdoctitle=' +
				r.title;
	...
	function H(a, b, c) {
		...
		if (g)
			if ((typeof a.id == f && (a.id = c), n.ie && n.win)) {
					...
					a[k] != Object.prototype[k] &&
						('data' == k.toLowerCase()
							...
							: 'styleclass' == k.toLowerCase()
								? (h += ' class="' + a[k] + '"')
								: 'classid' != k.toLowerCase() && (h += ' ' + k + '="' + a[k] + '"'));
				k = '';
				for (var m in b)
					b[m] != Object.prototype[m] && (k += '<param name="' + m + '" value="' + b[m] + '" />');
				g.outerHTML =
					'<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + h + '>' + k + '</object>';
				O[O.length] = a.id;
				d = e(a.id);
			} else {
				m = r.createElement(j);
				...
				for (var p in a)
					a[p] != Object.prototype[p] &&
						('styleclass' == p.toLowerCase()
							? m.setAttribute('class', a[p])
							: 'classid' != p.toLowerCase() && m.setAttribute(p, a[p]));
				for (h in b)
			...
			if (e) {
				...
				if (!m || t != c)
					(d = r.createElement('style')),
						...
						(m = e.appendChild(d)),
						n.ie &&
							(n.win && typeof r.styleSheets != f && 0 < r.styleSheets.length) &&
							(m = r.styleSheets[r.styleSheets.length - 1]),
						(t = c);
				n.ie && n.win
					? m && typeof m.addRule == j && m.addRule(a, b)
					: m && typeof r.createTextNode != f && m.appendChild(r.createTextNode(a + ' {' + b + '}'));
			}
		}
	}
	function d(a, b) {
	...
	var f = 'undefined',
		...
		J = !0,
		n,
		P = typeof r.getElementById != f && typeof r.getElementsByTagName != f && typeof r.createElement != f,
	...
	if (typeof K.plugins != f && typeof K.plugins['Shockwave Flash'] == j) {
		if (
			(B = K.plugins['Shockwave Flash'].description) &&
			!(typeof K.mimeTypes != f && K.mimeTypes[l] && !K.mimeTypes[l].enabledPlugin)
		)
			(ba = !0),
				(Q = !1),
	...
	n = { w3: P, pv: D, wk: F, ie: Q, win: W, mac: G };
	n.w3 &&
		(((typeof r.readyState != f && 'complete' == r.readyState) ||
			(typeof r.readyState == f && (r.getElementsByTagName('body')[0] || r.body))) &&
			v(),
		E ||
			(typeof r.addEventListener != f && r.addEventListener('DOMContentLoaded', v, !1),
			n.ie &&
				n.win &&
	...
	return {
		...
		embedSWF: function(b, c, e, g, h, l, m, p, q, r) {
			...
			n.w3 && !(n.wk && 312 > n.wk) && b && c && e && g && h
				? (d(c, !1),
					s(function() {
						e += '';
						g += '';
						var n = {};
						if (q && typeof q === j) for (var s in q) n[s] = q[s];
						n.data = b;
						n.width = e;
						n.height = g;
						s = {};
						if (p && typeof p === j) for (var u in p) s[u] = p[u];
						if (m && typeof m === j)
							for (var v in m)
								s.flashvars =
									typeof s.flashvars != f ? s.flashvars + ('&' + v + '=' + m[v]) : v + '=' + m[v];
		...
		expressInstallCallback: function() {
			if (N) {
				...
				a &&
					...
					A && (d(A, !0), n.ie && n.win && (S.style.display = 'block')),
					Y && Y(I));
				N = !1;
			}
		}
		...
		u.readyState
			? (u.onreadystatechange = function() {
					if ('loaded' == u.readyState || 'complete' == u.readyState)
						(u.onreadystatechange = null), loadHtml5Gallery(s);
				})
			: (u.onload = function() {
					loadHtml5Gallery(s);
				});
