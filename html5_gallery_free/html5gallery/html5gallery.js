				...
				var d =
					...
					d =
						...
						(' .html5gallery-title-' +
							...
							'; overflow:hidden; position:absolute; left:0px; width:' +
							c +
							'px; '),
					d = this.options.titleoverlay
						? 'top' == this.options.headerpos
			...
			createStyleDefault: function() {
				...
				this.options.showcarousel && this.options.carouselmultirows
					? ((a +=
							' .html5gallery-car-' +
							this.id +
							' { position:absolute; display:block; overflow:hidden; left:' +
							this.options.carouselLeft +
							'px; top:' +
							this.options.carouselTop +
							'px; width:' +
					...
					: this.options.showcarousel
						? ((a +=
							...
							(a +=
								' .html5gallery-car-list-' +
								this.id +
								' { position:absolute; display:block; overflow:hidden; left:4px; width:' +
